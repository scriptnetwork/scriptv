...
function dosource {
    ...
    ret=$?
    if [[ $ret -ne 0 ]]; then
        >&2 echo "KO 40938 Compilation Error"
        exit 1
    fi
}
...
#    echo "ret=$ret"
#        if [[ $ret -ne 0 ]]; then
#            >&2 echo "Compilation error. Aborting."
#            exit 1
#        fi
#    done
...
function select_cryptosuite {
    if [[ -f selected_cryptosuite ]]; then
    ...
    if [[ $android -eq 1 ]]; then
        ...
        find us/gov/crypto -type f ! -type l -name "*.java" -exec sed -i "s/import org.bouncycastle./import org.spongycastle./g" {} \;
        find us/gov/socket -type f ! -type l -name "*.java" -exec sed -i "s/import org.bouncycastle./import org.spongycastle./g" {} \;
        find test/us/gov/crypto -type f ! -type l -name "*.java" -exec sed -i "s/import org.bouncycastle./import org.spongycastle./g" {} \;
        find ../../../mim/core0/core0_5/us/gov/socket/datagram -type f ! -type l -name "*.java" -exec sed -i "s/import org.bouncycastle./import org.spongycastle./g" {} \;
    else
        echo "using bouncycastle"
        find us/gov/crypto -type f ! -type l -name "*.java" -exec sed -i "s/import org.spongycastle./import org.bouncycastle./g" {} \;
        find us/gov/socket -type f ! -type l -name "*.java" -exec sed -i "s/import org.spongycastle./import org.bouncycastle./g" {} \;
        find test/us/gov/crypto -type f ! -type l -name "*.java" -exec sed -i "s/import org.spongycastle./import org.bouncycastle./g" {} \;
        find ../../../mim/core0/core0_5/us/gov/socket/datagram -type f ! -type l -name "*.java" -exec sed -i "s/import org.spongycastle./import org.bouncycastle./g" {} \;
    fi
