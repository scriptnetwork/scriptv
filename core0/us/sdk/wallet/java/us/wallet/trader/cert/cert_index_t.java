...
public class cert_index_t extends HashMap<hash_t, string> implements us.gov.io.seriable {
...
/*
    public ArrayList<pair<hash_t, string>> to_vector() {
        ArrayList<pair<hash_t, string>> o = new ArrayList<pair<hash_t, string>>();
        o.ensureCapacity(size());
