...
public interface dto {
    ...
    /// mint_seal - IN
    public static final class mint_seal_in_t extends blob_writer_t.writable {
        //source: coder_java.cpp::gen_dto_in_hdr (1)

        public mint_seal_in_t(final hash_t addr, final uint8_t relay) {
            this.addr = addr;
            this.relay = relay;
        }
        ...
        public datagram get_datagram(final channel_t channel, final seq_t seq) {
            return super.get_datagram(channel, new svc_t(protocol.wallet_mint_seal), seq);
        }

        public static datagram get_datagram(final channel_t channel, final seq_t seq, final hash_t addr, final uint8_t relay) {
            mint_seal_in_t o = new mint_seal_in_t(addr, relay);
            return o.get_datagram(channel, seq);
        }
    ...
    /// udp_send - IN
    public static final class udp_send_in_t extends blob_writer_t.writable {
        //source: coder_java.cpp::gen_dto_in_hdr (1)

        public udp_send_in_t(final hash_t chan, final bin_t stream_chunk) {
            this.chan = chan;
            this.stream_chunk = stream_chunk;
        }

        @Override public int blob_size() {
            return blob_writer_t.blob_size(chan) +
                blob_writer_t.blob_size(stream_chunk);
        }

        @Override public void to_blob(blob_writer_t writer) {
            writer.write(chan);
            writer.write(stream_chunk);
        }

        public datagram get_datagram(final channel_t channel, final seq_t seq) {
            return super.get_datagram(channel, new svc_t(protocol.wallet_udp_send), seq);
        }

        public static datagram get_datagram(final channel_t channel, final seq_t seq, final hash_t chan, final bin_t stream_chunk) {
            udp_send_in_t o = new udp_send_in_t(chan, stream_chunk);
            return o.get_datagram(channel, seq);
        }

        final hash_t chan;
        final bin_t stream_chunk;
    }

    /// data_source_connect - IN
    public static final class data_source_connect_in_t extends blob_writer_t.writable {
        //source: coder_java.cpp::gen_dto_in_hdr (1)

        public data_source_connect_in_t(final string name, final hash_t address) {
            this.name = name;
        ...
        public datagram get_datagram(final channel_t channel, final seq_t seq) {
            return super.get_datagram(channel, new svc_t(protocol.wallet_data_source_connect), seq);
        }

        public static datagram get_datagram(final channel_t channel, final seq_t seq, final string name, final hash_t address) {
            data_source_connect_in_t o = new data_source_connect_in_t(name, address);
            return o.get_datagram(channel, seq);
        }

        final string name;
        final hash_t address;
    }

    /// timeseries_add_local_cert - IN
    public static final class timeseries_add_local_cert_in_t extends blob_writer_t.writable {
        //source: coder_java.cpp::gen_dto_in_hdr (1)

        public timeseries_add_local_cert_in_t(final hash_t addr, final hash_t nft) {
            this.addr = addr;
            this.nft = nft;
        }
        ...
        public datagram get_datagram(final channel_t channel, final seq_t seq) {
            return super.get_datagram(channel, new svc_t(protocol.wallet_timeseries_add_local_cert), seq);
        }

        public static datagram get_datagram(final channel_t channel, final seq_t seq, final hash_t addr, final hash_t nft) {
            timeseries_add_local_cert_in_t o = new timeseries_add_local_cert_in_t(addr, nft);
            return o.get_datagram(channel, seq);
        }
    ...
    /// timeseries__get_cert - IN
    public static final class timeseries__get_cert_in_t extends blob_writer_t.writable {
        //source: coder_java.cpp::gen_dto_in_hdr (1)

        public timeseries__get_cert_in_t(final hash_t addr, final uint64_t ts_from, final uint64_t ts_to) {
            this.addr = addr;
        ...
        @Override public int blob_size() {
            return blob_writer_t.blob_size(addr) +
                blob_writer_t.blob_size(ts_from) +
                blob_writer_t.blob_size(ts_to);
        }

        @Override public void to_blob(blob_writer_t writer) {
            writer.write(addr);
            writer.write(ts_from);
            writer.write(ts_to);
        }

        public datagram get_datagram(final channel_t channel, final seq_t seq) {
            return super.get_datagram(channel, new svc_t(protocol.wallet_timeseries__get_cert), seq);
        }

        public static datagram get_datagram(final channel_t channel, final seq_t seq, final hash_t addr, final uint64_t ts_from, final uint64_t ts_to) {
            timeseries__get_cert_in_t o = new timeseries__get_cert_in_t(addr, ts_from, ts_to);
            return o.get_datagram(channel, seq);
        }

        final hash_t addr;
        final uint64_t ts_from;
        final uint64_t ts_to;
    }
    //-/----------------------------------------------------------___end___------generated by configure, do not edit.
    ...
    public static final class mint_seal_in_dst_t extends blob_reader_t.readable {
        //source: coder_java.cpp::gen_dto_in_hdr (2)

        public mint_seal_in_dst_t() {}
    ...
    public static final class udp_send_in_dst_t extends blob_reader_t.readable {
        //source: coder_java.cpp::gen_dto_in_hdr (2)

        public udp_send_in_dst_t() {}
        ...
        @Override public ko from_blob(blob_reader_t reader) {
            ...
            {
                ko r = reader.read(stream_chunk);
                if (ko.is_ko(r)) return r;
            }
            return ok;
        }

        public hash_t chan = new hash_t();
        public bin_t stream_chunk = new bin_t();
    }

    public static final class data_source_connect_in_dst_t extends blob_reader_t.readable {
        //source: coder_java.cpp::gen_dto_in_hdr (2)

        public data_source_connect_in_dst_t() {}
        ...
        public string name = new string();
        public hash_t address = new hash_t();
    }

    public static final class timeseries_add_local_cert_in_dst_t extends blob_reader_t.readable {
        //source: coder_java.cpp::gen_dto_in_hdr (2)

        public timeseries_add_local_cert_in_dst_t() {}
        ...
        public hash_t addr = new hash_t();
        public hash_t nft = new hash_t();
    }

    public static final class timeseries__get_cert_in_dst_t extends blob_reader_t.readable {
        //source: coder_java.cpp::gen_dto_in_hdr (2)

        public timeseries__get_cert_in_dst_t() {}
        ...
        @Override public ko from_blob(blob_reader_t reader) {
            ...
            {
                ko r = reader.read(ts_from);
                if (ko.is_ko(r)) return r;
            }
            {
                ko r = reader.read(ts_to);
                if (ko.is_ko(r)) return r;
            }
            return ok;
        }
        ...
        public hash_t addr = new hash_t();
        public uint64_t ts_from = new uint64_t();
        public uint64_t ts_to = new uint64_t();
    }
    //-/----------------------------------------------------------___end___------generated by configure, do not edit.
