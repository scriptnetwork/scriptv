...
import us.wallet.engine.bookmark_index_t;                                                      // bookmark_index_t
...
import us.wallet.engine.bookmark_index_t;                                                                              // string
import us.wallet.wallet.timeseries_index_t;                                                                              // string
import us.wallet.trader.cert.cert_index_t;                                                                              // string
import us.wallet.trader.cert.cert_t;                                                                              // string
import us.wallet.wallet.timeseries_entry_index_t;                                                                              // string
import us.wallet.trader.trades_index_t;                                                                              // string

public interface caller_api extends dto {

    //#include <us/api/generated/wallet/java/engine/cllr_purevir>
    //------------------------------------------------------------__begin__------generated by configure, do not edit.
    //content of file: <us/api/generated/wallet/java/engine/cllr_purevir>
    // engine - master file: us/api/data/wallet/engine
      ...
      ko call_r2r_all_index_hdr(protocols_t protocols);
      ko call_r2r_all_bookmarks(final protocol_selection_t protocol_selection, bookmarks_t bookmarks);
      ko call_r2r_all_index(bookmark_index_t bookmark_index);
    //-/----------------------------------------------------------___end___------generated by configure, do not edit.
    //#include <us/api/generated/wallet/java/pairing/cllr_purevir>
    //------------------------------------------------------------__begin__------generated by configure, do not edit.
    //content of file: <us/api/generated/wallet/java/pairing/cllr_purevir>
    ...
    //-/----------------------------------------------------------___end___------generated by configure, do not edit.
    //#include <us/api/generated/wallet/java/r2r/cllr_purevir>
    //------------------------------------------------------------__begin__------generated by configure, do not edit.
    //content of file: <us/api/generated/wallet/java/r2r/cllr_purevir>
    // r2r - master file: us/api/data/wallet/r2r

      ko call_trading_msg(final trading_msg_in_t o_in);
      ko call_trading_msg2(final trading_msg2_in_t o_in);
    //-/----------------------------------------------------------___end___------generated by configure, do not edit.
    //#include <us/api/generated/wallet/java/wallet/cllr_purevir>
    //------------------------------------------------------------__begin__------generated by configure, do not edit.
    //content of file: <us/api/generated/wallet/java/wallet/cllr_purevir>
    // wallet - master file: us/api/data/wallet/wallet
      ...
      ko call_r2r_index_hdr(protocols_t protocols);
      ko call_r2r_bookmarks(final protocol_selection_t protocol_selection, bookmarks_t bookmarks);
      ko call_r2r_index(bookmark_index_t bookmark_index);
      ko call_cert_create(final string msg, hash_t nft);
      ko call_cert_import(final cert_t cert, hash_t nft);
      ko call_cert_list(final uint8_t id, cert_index_t certs);
      ko call_cert_get(final hash_t nft, cert_t cert);
      ko call_cert_show(final hash_t nft, string cert);
      ko call_list_businesses(protocols_t protocols);
      ko call_accounts(accounts_t accounts);
      ko call_merge_accounts(account_t merged_account);
      ko call_mint_seal(final mint_seal_in_t o_in, blob_t blob_ev);
      ko call_udp_send(final udp_send_in_t o_in);
      ko call_data_sources(data_sources_index_t ans);
      ko call_data_source_connect(final data_source_connect_in_t o_in, string result);
      ko call_timeseries_list1(timeseries_index_t ans);
      ko call_timeseries_new1(final uint8_t monotonic, hash_t addr);
      ko call_timeseries_add_local_cert(final timeseries_add_local_cert_in_t o_in, string ans);
      ko call_timeseries__get_cert(final timeseries__get_cert_in_t o_in, cert_t ans);
      ko call_trades_index(trades_index_t index);
      ko call_account(final hash_t address, account_t account);
      ko call_timeseries_entry_index(final hash_t addr, timeseries_entry_index_t ans);
    //-/----------------------------------------------------------___end___------generated by configure, do not edit.
