...
import us.gov.cash.account_t;                                                                  // account_t
import us.gov.cash.accounts_t;                                                                  // account_t
...
import us.wallet.trader.cert.cert_index_t;                                                     // cert_index_t
import us.wallet.trader.cert.cert_t;                                                           // cert_t
import us.CFG;                                                                                 // CFG
...
import us.wallet.trader.bootstrap.protocols_t;                                                 // protocols_t
...
public abstract class rpc_peer_t extends us.gov.relay.rpc_peer_t implements caller_api {
    ...
    @Override public ko call_print_grid(string data) {
        ...
        return blob_reader_t.readD(d_in, data);
    }
    ...
    @Override public ko call_reload_file(final string filename, string ans) {
        ...
        return blob_reader_t.readD(d_in, ans);
    }
    ...
    @Override public ko call_get_component_update(final get_component_update_in_t o_in, get_component_update_out_dst_t o_out) {
        ...
        return blob_reader_t.readD(d_in, o_out);
    }
    ...
    @Override public ko call_get_component_hash(final get_component_hash_in_t o_in, string curver) {
        ...
        return blob_reader_t.readD(d_in, curver);
    }
    ...
    @Override public ko call_world(vector_hash wallets) {
        ...
        return blob_reader_t.readD(d_in, wallets);
    }
    ...
    @Override public ko call_r2r_all_index_hdr(protocols_t protocols) {
        ...
        return blob_reader_t.readD(d_in, protocols);
    }
    ...
    @Override public ko call_r2r_all_bookmarks(final protocol_selection_t protocol_selection, bookmarks_t bookmarks) {
        ...
        return blob_reader_t.readD(d_in, bookmarks);
    }
    ...
    @Override public ko call_r2r_all_index(bookmark_index_t bookmark_index) {
        ...
        return blob_reader_t.readD(d_in, bookmark_index);
    }
    ...
    @Override public ko call_recv_address(hash_t addr) {
        ...
        return blob_reader_t.readD(d_in, addr);
    }
    ...
    @Override public ko call_transfer(final transfer_in_t o_in, blob_t blob_ev) {
        ...
        return blob_reader_t.readD(d_in, blob_ev);
    }
    ...
    @Override public ko call_invoice_verify(final invoice_verify_in_t o_in, string err) {
        ...
        return blob_reader_t.readD(d_in, err);
    }
    ...
    @Override public ko call_tx_pay(final tx_pay_in_t o_in, blob_t blob_ev2) {
        ...
        return blob_reader_t.readD(d_in, blob_ev2);
    }
    ...
    @Override public ko call_tx_send(final blob_t blob_ev, string info) {
        ...
        return blob_reader_t.readD(d_in, info);
    }
    ...
    @Override public ko call_tx_decode(final blob_t blob_ev, string tx_pretty) {
        ...
        return blob_reader_t.readD(d_in, tx_pretty);
    }
    ...
    @Override public ko call_search(final search_in_t o_in, string result) {
        ...
        return blob_reader_t.readD(d_in, result);
    }
    ...
    @Override public ko call_file(final hash_t digest, bin_t content) {
        ...
        return blob_reader_t.readD(d_in, content);
    }
    ...
    @Override public ko call_get_subhome(string subhome) {
        ...
        return blob_reader_t.readD(d_in, subhome);
    }
    ...
    @Override public ko call_encrypt(final encrypt_in_t o_in, bin_t msg_scrambled) {
        ...
        return blob_reader_t.readD(d_in, msg_scrambled);
    }
    ...
    @Override public ko call_decrypt(final decrypt_in_t o_in, bin_t msg) {
        ...
        return blob_reader_t.readD(d_in, msg);
    }
    ...
    @Override public ko call_trade(final trade_in_t o_in, hash_t tid) {
        ...
        return blob_reader_t.readD(d_in, tid);
    }
    ...
    @Override public ko call_cert_create(final string msg, hash_t nft) {
        ...
        return blob_reader_t.readD(d_in, nft);
    }
    ...
    @Override public ko call_cert_list(final uint8_t id, cert_index_t certs) {
        ...
        return blob_reader_t.readD(d_in, certs);
    }
    ...
    @Override public ko call_cert_get(final hash_t nft, cert_t cert) {
        ...
        return blob_reader_t.readD(d_in, cert);
    }
    ...
    @Override public ko call_list_businesses(protocols_t protocols) {
        log("list_businesses "); //--strip
        datagram d_in;
        {
            string lasterr = new string();
            pair<ko, datagram> r = sendrecv(blob_writer_t.get_datagram(daemon.channel, new svc_t(protocol.wallet_list_businesses), new seq_t(0)), lasterr);
            if (ko.is_ko(r.first)) {
                assert r.second == null;
                if (lasterr.value != null) {
                    lasterror.set(lasterr.value);
        ...
        if (d_in.service.value != protocol.wallet_list_businesses_response) {
            ko r = KO_50143;
            log(r.msg + "expected " + protocol.wallet_list_businesses_response + " got " + d_in.service.value); //--strip
            return r;
        }
        return blob_reader_t.readD(d_in, protocols);
    }

    @Override public ko call_accounts(accounts_t accounts) {
        log("accounts "); //--strip
        datagram d_in;
        {
            string lasterr = new string();
            pair<ko, datagram> r = sendrecv(blob_writer_t.get_datagram(daemon.channel, new svc_t(protocol.wallet_accounts), new seq_t(0)), lasterr);
            if (ko.is_ko(r.first)) {
                assert r.second == null;
                if (lasterr.value != null) {
                    lasterror.set(lasterr.value);
        ...
        if (d_in.service.value != protocol.wallet_accounts_response) {
            ko r = KO_50143;
            log(r.msg + "expected " + protocol.wallet_accounts_response + " got " + d_in.service.value); //--strip
            return r;
        }
        return blob_reader_t.readD(d_in, accounts);
    }

    @Override public ko call_merge_accounts(account_t merged_account) {
        log("merge_accounts "); //--strip
        datagram d_in;
        {
            string lasterr = new string();
            pair<ko, datagram> r = sendrecv(blob_writer_t.get_datagram(daemon.channel, new svc_t(protocol.wallet_merge_accounts), new seq_t(0)), lasterr);
            if (ko.is_ko(r.first)) {
                assert r.second == null;
                if (lasterr.value != null) {
                    lasterror.set(lasterr.value);
        ...
        if (d_in.service.value != protocol.wallet_merge_accounts_response) {
            ko r = KO_50143;
            log(r.msg + "expected " + protocol.wallet_merge_accounts_response + " got " + d_in.service.value); //--strip
            return r;
        }
        return blob_reader_t.readD(d_in, merged_account);
    }

    @Override public ko call_mint_seal(final mint_seal_in_t o_in, blob_t blob_ev) {
        log("mint_seal "); //--strip
        /// in:
        ///     hash_t addr;
        ///     uint8_t relay;
        ...
        if (d_in.service.value != protocol.wallet_mint_seal_response) {
            ko r = KO_50143;
            log(r.msg + "expected " + protocol.wallet_mint_seal_response + " got " + d_in.service.value); //--strip
            return r;
        }
        return blob_reader_t.readD(d_in, blob_ev);
    }

    @Override public ko call_udp_send(final udp_send_in_t o_in) {
        log("udp_send "); //--strip
        /// in:
        ///     hash_t chan;
        ///     bin_t stream_chunk;
    ...
    @Override public ko call_data_sources(data_sources_index_t ans) {
        log("data_sources "); //--strip
        datagram d_in;
        {
            string lasterr = new string();
            pair<ko, datagram> r = sendrecv(blob_writer_t.get_datagram(daemon.channel, new svc_t(protocol.wallet_data_sources), new seq_t(0)), lasterr);
            if (ko.is_ko(r.first)) {
                assert r.second == null;
                if (lasterr.value != null) {
                    lasterror.set(lasterr.value);
        ...
        if (d_in.service.value != protocol.wallet_data_sources_response) {
            ko r = KO_50143;
            log(r.msg + "expected " + protocol.wallet_data_sources_response + " got " + d_in.service.value); //--strip
            return r;
        }
        return blob_reader_t.readD(d_in, ans);
    }

    @Override public ko call_data_source_connect(final data_source_connect_in_t o_in, string result) {
        log("data_source_connect "); //--strip
        /// in:
        ///     string name;
        ///     hash_t address;
        ...
        if (d_in.service.value != protocol.wallet_data_source_connect_response) {
            ko r = KO_50143;
            log(r.msg + "expected " + protocol.wallet_data_source_connect_response + " got " + d_in.service.value); //--strip
            return r;
        }
        return blob_reader_t.readD(d_in, result);
    }

    @Override public ko call_timeseries_list1(timeseries_index_t ans) {
        log("timeseries_list1 "); //--strip
        datagram d_in;
        {
            string lasterr = new string();
            pair<ko, datagram> r = sendrecv(blob_writer_t.get_datagram(daemon.channel, new svc_t(protocol.wallet_timeseries_list1), new seq_t(0)), lasterr);
            if (ko.is_ko(r.first)) {
                assert r.second == null;
                if (lasterr.value != null) {
                    lasterror.set(lasterr.value);
        ...
        if (d_in.service.value != protocol.wallet_timeseries_list1_response) {
            ko r = KO_50143;
            log(r.msg + "expected " + protocol.wallet_timeseries_list1_response + " got " + d_in.service.value); //--strip
            return r;
        }
        return blob_reader_t.readD(d_in, ans);
    }

    @Override public ko call_timeseries_new1(final uint8_t monotonic, hash_t addr) {
        log("timeseries_new1 "); //--strip
        datagram d_in;
        {
            string lasterr = new string();
            pair<ko, datagram> r = sendrecv(blob_writer_t.get_datagram(daemon.channel, new svc_t(protocol.wallet_timeseries_new1), new seq_t(0), monotonic), lasterr);
            if (ko.is_ko(r.first)) {
                assert r.second == null;
                if (lasterr.value != null) {
                    lasterror.set(lasterr.value);
        ...
        if (d_in.service.value != protocol.wallet_timeseries_new1_response) {
            ko r = KO_50143;
            log(r.msg + "expected " + protocol.wallet_timeseries_new1_response + " got " + d_in.service.value); //--strip
            return r;
        }
        return blob_reader_t.readD(d_in, addr);
    }

    @Override public ko call_timeseries_add_local_cert(final timeseries_add_local_cert_in_t o_in, string ans) {
        log("timeseries_add_local_cert "); //--strip
        /// in:
        ///     hash_t addr;
        ///     hash_t nft;
        ...
        if (d_in.service.value != protocol.wallet_timeseries_add_local_cert_response) {
            ko r = KO_50143;
            log(r.msg + "expected " + protocol.wallet_timeseries_add_local_cert_response + " got " + d_in.service.value); //--strip
            return r;
        }
        return blob_reader_t.readD(d_in, ans);
    }

    @Override public ko call_timeseries__get_cert(final timeseries__get_cert_in_t o_in, cert_t ans) {
        log("timeseries__get_cert "); //--strip
        /// in:
        ///     hash_t addr;
        ///     uint64_t ts_from;
        ///     uint64_t ts_to;
        ...
        if (d_in.service.value != protocol.wallet_timeseries__get_cert_response) {
            ko r = KO_50143;
            log(r.msg + "expected " + protocol.wallet_timeseries__get_cert_response + " got " + d_in.service.value); //--strip
            return r;
        }
        return blob_reader_t.readD(d_in, ans);
    }

    @Override public ko call_trades_index(trades_index_t index) {
        log("trades_index "); //--strip
        datagram d_in;
        {
            string lasterr = new string();
            pair<ko, datagram> r = sendrecv(blob_writer_t.get_datagram(daemon.channel, new svc_t(protocol.wallet_trades_index), new seq_t(0)), lasterr);
            if (ko.is_ko(r.first)) {
                assert r.second == null;
                if (lasterr.value != null) {
                    lasterror.set(lasterr.value);
        ...
        if (d_in.service.value != protocol.wallet_trades_index_response) {
            ko r = KO_50143;
            log(r.msg + "expected " + protocol.wallet_trades_index_response + " got " + d_in.service.value); //--strip
            return r;
        }
        return blob_reader_t.readD(d_in, index);
    }

    @Override public ko call_account(final hash_t address, account_t account) {
        log("account "); //--strip
        datagram d_in;
        {
            string lasterr = new string();
            pair<ko, datagram> r = sendrecv(blob_writer_t.get_datagram(daemon.channel, new svc_t(protocol.wallet_account), new seq_t(0), address), lasterr);
            if (ko.is_ko(r.first)) {
                assert r.second == null;
                if (lasterr.value != null) {
                    lasterror.set(lasterr.value);
        ...
        if (d_in.service.value != protocol.wallet_account_response) {
            ko r = KO_50143;
            log(r.msg + "expected " + protocol.wallet_account_response + " got " + d_in.service.value); //--strip
            return r;
        }
        return blob_reader_t.readD(d_in, account);
    }

    @Override public ko call_timeseries_entry_index(final hash_t addr, timeseries_entry_index_t ans) {
        log("timeseries_entry_index "); //--strip
        datagram d_in;
        {
            string lasterr = new string();
            pair<ko, datagram> r = sendrecv(blob_writer_t.get_datagram(daemon.channel, new svc_t(protocol.wallet_timeseries_entry_index), new seq_t(0), addr), lasterr);
            if (ko.is_ko(r.first)) {
                assert r.second == null;
                if (lasterr.value != null) {
                    lasterror.set(lasterr.value);
        ...
        if (d_in.service.value != protocol.wallet_timeseries_entry_index_response) {
            ko r = KO_50143;
            log(r.msg + "expected " + protocol.wallet_timeseries_entry_index_response + " got " + d_in.service.value); //--strip
            return r;
        }
        return blob_reader_t.readD(d_in, ans);
    }
