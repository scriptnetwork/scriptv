...
public class handler_daemon_t extends bgtask implements bgtask.callback {
    ...
    @Override public void run_body() { //run_recv
        ...
        while (isup()) {
            ...
            if (ko.is_ko(r.first)) {
                ...
                if (r.first == datagram.KO_9021) {
                    ...
                    get_peer().disconnect(seq_t.zero, new reason_t());
                }
                    ...
                    get_peer().disconnectx(ch, seq_t.zero, msg);
                }
                else {
                    get_peer().disconnect(seq_t.zero, new reason_t(r.first.msg));
                }
                continue;
            }
