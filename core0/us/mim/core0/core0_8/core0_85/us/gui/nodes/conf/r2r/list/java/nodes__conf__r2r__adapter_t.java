...
//MIM  kickoff code hash: an64UGSE8GFErcvcpL3tEz7bvWQ (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash;
...
public final class nodes__conf__r2r__adapter_t extends list_view__adapter_t {

    private static void log(final String s) {                         //--strip
        CFG.log_scr("nodes__conf__r2r__adapter_t: " + s);                //--strip
    }                                                                 //--strip

    public nodes__conf__r2r__adapter_t(nodes__conf__r2r main_view_) {
        super();
    ...
    public final nodes__conf__r2r0__itemtype_t get_item(int pos) {
        assert data != null; //--strip
        return data.get(pos);
    }

    public void set_data(nodes__conf__r2r0__datatype_t data_) {
    ...
    public String get_nft(final nodes__conf__r2r0__itemtype_t i) {
        return i.nft();
    }
    ...
    public int find_nft__pos(final String nft) {
        ...
        int p = -1;
        for (nodes__conf__r2r0__itemtype_t i: data) {
            ++p;
    ...
    public nodes__conf__r2r0__itemtype_t find_nft__item(final String nft) {
    ...
    nodes__conf__r2r main_view;
    nodes__conf__r2r0__datatype_t data = null;
}
