...
//MIM  kickoff code hash: 2QoeaB1qgS2zDKw3WB5ZwK8Cczcd (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash.scr;
...
public class nodes__conf__wallets__widgets extends nodes__conf__wallets0__widgets  {

    private static void log(final String s) {                        //--strip
        us.cash.CFG.log_scr("nodes__conf__wallets__widgets: " + s);            //--strip
    }                                                                //--strip

    public nodes__conf__wallets__widgets(final list_view_t.itemclick_listener_t list_listener_) {
        super();
