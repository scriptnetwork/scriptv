...
//MIM    'controller': 'fragment' @ core0/core0_8/core0_85/us/gui/nodes/conf/bookmarks/mim.h
//MIM    'datatype': 'nodes__conf__bookmarks0__datatype_t' @ core0/core0_6/core0_61/us/gui/activity/listview_controller/base/mim.h
...
//MIM    'title': 'Bookmarks' @ core0/core0_8/core0_85/us/gui/nodes/conf/bookmarks/mim.h
//MIM  kickoff code hash: 2qcvNWoWJUJh3dPx4mmR9vkj1QtQ (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash;
...
public abstract class nodes__conf__bookmarks0 extends fragment {

    private static void log(final String line) {           //--strip
        CFG.log_android("nodes__conf__bookmarks0: " + line);         //--strip
    }                                                      //--strip

    public nodes__conf__bookmarks0() {
        super();
        log("nodes__conf__bookmarks0 constructor"); //--strip
    }
    ...
    @Override protected void controller__on_create(Bundle saved_state) {
        ...
        w = (us.cash.scr.nodes__conf__bookmarks0__widgets) super.w;
        assert w != null; //--strip
    ...
    public pair<ko, nodes__conf__bookmarks0__datatype_t> fetch_bookmarks() {
        log("fetch_bookmarks"); //--strip
        a.assert_worker_thread(); //--strip
        us.wallet.trader.bookmarks_t o = new us.wallet.trader.bookmarks_t();
        ko r = a.hmi().rpc_peer.call_bookmark_list(o);
        if (is_ko(r)) {
            return new pair<ko, nodes__conf__bookmarks0__datatype_t>(r, null);
        }
        return new pair<ko, nodes__conf__bookmarks0__datatype_t>(ok, new nodes__conf__bookmarks0__datatype_t(o));
    }
    ...
    @Override public ko load__worker() {
        ...
        pair<ko, nodes__conf__bookmarks0__datatype_t> r = fetch_bookmarks();
        if (is_ko(r.first)) {
            bookmarks = null;
            return r.first;
        }
    ...
    @Override protected us.cash.scr.menu_t get_menu() {
        ...
        return us.cash.scr.nodes__conf__bookmarks0__menu___main_t.get_instance(get_context());
    }
    //MIM end token 'get_menu_override'


    @Override public us.cash.scr.view__widgets create_widgets() {
        return new us.cash.scr.nodes__conf__bookmarks0__widgets();
    }

    us.cash.scr.nodes__conf__bookmarks0__widgets w = null;
    protected nodes__conf__bookmarks0__datatype_t bookmarks = null; //MIM token 'datatype_decl'
}
