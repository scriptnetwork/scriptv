...
//MIM  Params:
//MIM    'api__datatype': 'us.wallet.trader.bookmarks_t' @ core0/core0_8/core0_85/us/gui/nodes/conf/r2r/mim.h
//MIM    'classname': 'nodes__conf__r2r0'
//MIM    'include': 'import static us.gov...'
//MIM  kickoff code hash: iRUkRMxoqA3j5PsNSFpFrJsNhEd (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash;
...
public class nodes__conf__r2r0__datatype_t extends ArrayList<nodes__conf__r2r0__itemtype_t> {

    private static void log(final String line) {                       //--strip
        CFG.log_android("nodes__conf__r2r0__datatype_t: " + line);         //--strip
    }                                                                  //--strip

    public nodes__conf__r2r0__datatype_t(final us.wallet.trader.bookmarks_t o) {
        log("constructor "); //--strip
        //TODO: 
        add(new nodes__conf__r2r0__itemtype_t("example", null)); //kickoff entry - delete-
