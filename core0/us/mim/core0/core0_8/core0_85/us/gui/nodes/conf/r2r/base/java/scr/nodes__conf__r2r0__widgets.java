...
//MIM  kickoff code hash: TwBRbzaMWUM56eQJ4mXFtTsew4T (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash.scr;
...
public class nodes__conf__r2r0__widgets extends view__widgets {

    private static void log(final String s) {                        //--strip
        us.cash.CFG.log_scr("nodes__conf__r2r0__widgets: " + s);            //--strip
    }                                                                //--strip

    public nodes__conf__r2r0__widgets() {
        super();
    }
