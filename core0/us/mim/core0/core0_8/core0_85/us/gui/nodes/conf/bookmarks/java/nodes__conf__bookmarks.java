...
//MIM    'data_identifier': 'bookmarks' @ core0/core0_8/core0_85/us/gui/nodes/conf/bookmarks/mim.h
...
//MIM    'item_object_id': 'app.wallet__node_bookmark__object_id' @ core0/core0_8/core0_85/us/gui/nodes/conf/bookmarks/mim.h
//MIM    'item_title': 'bookmark' @ core0/core0_8/core0_85/us/gui/nodes/conf/bookmarks/mim.h
...
//MIM  kickoff code hash: 4YswARGPEc9Zi73J1hR78M1Qrpth (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash;
...
public class nodes__conf__bookmarks extends nodes__conf__bookmarks0 {

    private static void log(final String line) {           //--strip
        CFG.log_android("nodes__conf__bookmarks: " + line);         //--strip
    }                                                      //--strip

    public nodes__conf__bookmarks() {
        super();
        log("nodes__conf__bookmarks constructor"); //--strip
    }
    ...
    @Override protected void controller__on_create(Bundle saved_state) {  //create/resume order: 1-general class; 2-specialized class
        ...
        w = (us.cash.scr.nodes__conf__bookmarks__widgets) super.w;
        assert w != null; //--strip
    }
    ...
    public void bind(final nodes__conf__bookmarks0__datatype_t o) {
        log("bind"); //--strip
    ...
    @Override public us.cash.scr.view__widgets create_widgets() {
        final nodes__conf__bookmarks self = this;
        return new us.cash.scr.nodes__conf__bookmarks__widgets(new us.cash.scr.list_view_t.itemclick_listener_t() {
    ...
    us.cash.scr.nodes__conf__bookmarks__itemview__widgets create_itemview__widgets() {
        final nodes__conf__bookmarks self = this;
        return new us.cash.scr.nodes__conf__bookmarks__itemview__widgets(new us.cash.scr.nodes__conf__bookmarks__itemview__widgets.listener_t() {
    ...
    public us.cash.scr.list_view__itemview_t create_itemview(Context ctx) {
         return new us.cash.scr.nodes__conf__bookmarks__itemview_t(ctx, create_itemview__widgets(), adapter);
    }

    public nodes__conf__bookmarks__adapter_t create_adapter() {
        log("create_adapter");
        adapter = new nodes__conf__bookmarks__adapter_t(this);
    ...
    void on_item__long_click(final int pos) {
        ...
        //TODO: do something
        //nodes__conf__bookmarks0__itemtype_t item = adapter.get_item(pos);
    }
    ...
    protected us.cash.scr.nodes__conf__bookmarks__widgets w = null;
    public nodes__conf__bookmarks__adapter_t adapter = null;
