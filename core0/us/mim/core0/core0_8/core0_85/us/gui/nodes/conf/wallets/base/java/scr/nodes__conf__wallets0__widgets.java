...
//MIM  kickoff code hash: 4X7Tyj2cN4FZSf6zCi4ypGAPHvvW (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash.scr;
...
public class nodes__conf__wallets0__widgets extends view__widgets {

    private static void log(final String s) {                        //--strip
        us.cash.CFG.log_scr("nodes__conf__wallets0__widgets: " + s);            //--strip
    }                                                                //--strip

    public nodes__conf__wallets0__widgets() {
        super();
    }
