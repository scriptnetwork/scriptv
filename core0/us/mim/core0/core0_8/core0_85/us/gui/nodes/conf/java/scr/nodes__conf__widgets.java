...
//MIM  kickoff code hash: 4GkcuASwmcWSPqWw4PNzTxoaz4XQ (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash.scr;
...
public class nodes__conf__widgets extends nodes__conf__base__widgets {

    private static void log(final String s) {                        //--strip
        us.cash.CFG.log_scr("nodes__conf__widgets: " + s);            //--strip
    }                                                                //--strip

    public nodes__conf__widgets() {
        super();
    }
