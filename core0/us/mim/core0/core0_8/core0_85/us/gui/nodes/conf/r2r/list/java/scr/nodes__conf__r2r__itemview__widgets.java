...
//MIM  kickoff code hash: 3cZRDMmxbeKgQj91UUsZZ3M7DQz8 (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash.scr;
...
public class nodes__conf__r2r__itemview__widgets extends list_view__itemview__widgets {

    private static void log(final String s) {                             //--strip
        CFG.log_scr("nodes__conf__r2r__itemview__widgets: " + s);            //--strip
    }                                                                     //--strip
    ...
    public nodes__conf__r2r__itemview__widgets(listener_t listener_) {
        listener = listener_;
    }
