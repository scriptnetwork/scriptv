...
//MIM  Params:
//MIM    'classname': 'nodes__conf__wallets'
//MIM    'conf_button__click_handler': 'void on_confitem_but...' @ core0/core0_6/core0_61/us/gui/activity/listview_controller/mim.h
//MIM    'data_identifier': 'wallets' @ core0/core0_8/core0_85/us/gui/nodes/conf/wallets/mim.h
//MIM    'datatype': 'nodes__conf__wallets0__datatype_t' @ core0/core0_8/core0_85/us/gui/nodes/conf/wallets/mim.h
...
//MIM    'item_object_id': 'app.wallet__node_address__object_id' @ core0/core0_8/core0_85/us/gui/nodes/conf/wallets/mim.h
//MIM    'item_title': 'wallet' @ core0/core0_8/core0_85/us/gui/nodes/conf/wallets/mim.h
//MIM    'itemico': 'R.raw.wallet' @ core0/core0_8/core0_85/us/gui/nodes/conf/wallets/mim.h
//MIM    'itemtype': 'nodes__conf__wallets0__itemtype_t' @ core0/core0_8/core0_85/us/gui/nodes/conf/wallets/mim.h
...
//MIM  kickoff code hash: 32nemaoHmveeBofKCEpkz3UNHTBm (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash;
...
public class nodes__conf__wallets extends nodes__conf__wallets0 {

    private static void log(final String line) {           //--strip
        CFG.log_android("nodes__conf__wallets: " + line);         //--strip
    }                                                      //--strip

    public nodes__conf__wallets() {
        super();
        log("nodes__conf__wallets constructor"); //--strip
    }
    ...
    @Override protected void controller__on_create(Bundle saved_state) {  //create/resume order: 1-general class; 2-specialized class
        ...
        w = (us.cash.scr.nodes__conf__wallets__widgets) super.w;
        assert w != null; //--strip
    }
    ...
    public void bind(final nodes__conf__wallets0__datatype_t o) {
        log("bind"); //--strip
    ...
    @Override public us.cash.scr.view__widgets create_widgets() {
        final nodes__conf__wallets self = this;
        return new us.cash.scr.nodes__conf__wallets__widgets(new us.cash.scr.list_view_t.itemclick_listener_t() {
    ...
    us.cash.scr.nodes__conf__wallets__itemview__widgets create_itemview__widgets() {
        final nodes__conf__wallets self = this;
        return new us.cash.scr.nodes__conf__wallets__itemview__widgets(new us.cash.scr.nodes__conf__wallets__itemview__widgets.listener_t() {
    ...
    public us.cash.scr.list_view__itemview_t create_itemview(Context ctx) {
         return new us.cash.scr.nodes__conf__wallets__itemview_t(ctx, create_itemview__widgets(), adapter);
    }

    public nodes__conf__wallets__adapter_t create_adapter() {
        log("create_adapter");
        adapter = new nodes__conf__wallets__adapter_t(this);
    ...
    void on_item__long_click(final int pos) {
        ...
        //TODO: do something
        //nodes__conf__wallets0__itemtype_t item = adapter.get_item(pos);
    }
    ...
    @Override public void on_ready(final ko load_result) {
        ...
        assert adapter != null;
        adapter.set_data(wallets);
        bind(wallets);
    }

    //MIM begin token 'popups'
    public void popup_menu__conf(final int pos) {
        final nodes__conf__wallets0__itemtype_t item = adapter.get_item(pos);
        a.show_contextual_options_for(get_context(), R.raw.wallet, "wallet", app.wallet__node_address__object_id, item.nft());
    }
    //MIM end token 'popups'

/*
    void start_trade(final nodes__conf__wallets0__itemtype_t item) {
        hash_t i = new hash_t(item.nft());
        endpoint_t ep = new endpoint_t(a.hmi().p.channel, i);
        bookmark_t bm = new bookmark_t(ep);
        a.set_clipboard(bm.qr.to_string(), "remote wallet QR");
//        toast(bm.qr.to_string());
    }

    void copy_qr(final nodes__conf__wallets0__itemtype_t item) {
        hash_t i = new hash_t(item.nft());
        endpoint_t ep = new endpoint_t(a.hmi().p.channel, i);
        bookmark_t bm = new bookmark_t(ep);
        a.set_clipboard(bm.qr.to_string(), "remote wallet QR");
...
*/
    ...
    protected us.cash.scr.nodes__conf__wallets__widgets w = null;
    public nodes__conf__wallets__adapter_t adapter = null;
