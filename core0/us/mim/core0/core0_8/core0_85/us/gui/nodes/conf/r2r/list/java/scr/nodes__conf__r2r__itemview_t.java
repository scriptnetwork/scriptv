...
//MIM  kickoff code hash: 2uMU5YnogVXfupoLACtEgUBAWhwv (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash.scr;
...
import us.cash.nodes__conf__r2r0__itemtype_t;

public final class nodes__conf__r2r__itemview_t extends list_view__itemview_t {

    private static void log(final String s) {                    //--strip
        CFG.log_scr("nodes__conf__r2r__itemview_t: " + s);          //--strip
    }                                                            //--strip

    public nodes__conf__r2r__itemview_t(Context ctx, nodes__conf__r2r__itemview__widgets w, final us.cash.nodes__conf__r2r__adapter_t adapter) {
        super(ctx, w, adapter);
        this.w = w;
    ...
    nodes__conf__r2r__itemview__widgets w = null;
    us.cash.nodes__conf__r2r__adapter_t adapter = null;
}
