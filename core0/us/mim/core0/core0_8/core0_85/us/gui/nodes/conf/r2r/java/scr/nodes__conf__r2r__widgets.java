...
//MIM  kickoff code hash: 3Jb2ygkL8TJ8CmkFCMgoheS7pWYA (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash.scr;
...
public class nodes__conf__r2r__widgets extends nodes__conf__r2r0__widgets  {

    private static void log(final String s) {                        //--strip
        us.cash.CFG.log_scr("nodes__conf__r2r__widgets: " + s);            //--strip
    }                                                                //--strip

    public nodes__conf__r2r__widgets(final list_view_t.itemclick_listener_t list_listener_) {
        super();
