...
//MIM  kickoff code hash: 4HyWFHhxzcPTiXTNFPVXYZv89NFr (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash.scr;
...
public class nodes__conf__base__widgets extends view__widgets {

    private static void log(final String s) {                        //--strip
        us.cash.CFG.log_scr("nodes__conf__base__widgets: " + s);            //--strip
    }                                                                //--strip

    public nodes__conf__base__widgets() {
        super();
    }
