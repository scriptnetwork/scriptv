...
//MIM  kickoff code hash: HvgUVp79W25KUuuEed2tPfxPXAZ (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash.scr;
...
public class certs__conf__all0__widgets extends view__widgets {

    private static void log(final String s) {                        //--strip
        us.cash.CFG.log_scr("certs__conf__all0__widgets: " + s);            //--strip
    }                                                                //--strip

    public certs__conf__all0__widgets() {
        super();
    }
