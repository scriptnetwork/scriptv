...
//MIM    'include': ''
//MIM  kickoff code hash: 4LUUaTqNhphoXho3wKTYDzb1YZBR (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash.scr;
...
public class certs__conf__widgets extends certs__conf__base__widgets {

    private static void log(final String s) {                        //--strip
        us.cash.CFG.log_scr("certs__conf__widgets: " + s);            //--strip
    }                                                                //--strip

    public certs__conf__widgets() {
        super();
    }
