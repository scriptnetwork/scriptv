...
//MIM  kickoff code hash: 3eBYVDB2Q1QY6SWQQdfmKUC9LjyN (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash.scr;
...
public class certs__conf__all__itemview__widgets extends list_view__itemview__widgets {

    private static void log(final String s) {                             //--strip
        CFG.log_scr("certs__conf__all__itemview__widgets: " + s);            //--strip
    }                                                                     //--strip


    public certs__conf__all__itemview__widgets() {
    }
    ...
    @Override public ViewGroup create_tree(Context ctx) {
        super.create_tree(ctx); {
            canvas_t left = new canvas_t(ctx, 12, 1); {
                ico = new button_t(ctx, R.raw.cert, null); {
