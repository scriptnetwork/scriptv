...
//MIM  kickoff code hash: o78oVKsNcaUiVU4pXtgVqz5tZZ2 (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash;
...
public class certs__conf extends certs__conf__base {

    private static void log(final String line) {           //--strip
        CFG.log_android("certs__conf: " + line);         //--strip
    }                                                      //--strip

    public certs__conf() {
        super();
        log("certs__conf constructor"); //--strip
    }
    ...
    @Override protected void controller__on_create(Bundle saved_state) {
        ...
        log("on_create"); //--strip
        w = (us.cash.scr.certs__conf__widgets) super.w;
        assert w != null; //--strip
    ...
    @Override public us.cash.scr.view__widgets create_widgets() {
        return new us.cash.scr.certs__conf__widgets();
    }
    ...
    void add_tabs() {
        ...
        if (onlytab != -1) {
            switch(onlytab) {
                case 0:
                    add_tab(0, "All", R.raw.fairluckico);
                    break;
                case 1:
                    add_tab(0, "SoA", R.raw.fairluckico);
                    break;
            }
            return;
        }
        add_tab(0, "All", R.raw.fairluckico);
        add_tab(1, "SoA", R.raw.fairluckico);
    }
    ...
    fragment get_fragment(int pos) {
        ...
        if (onlytab != -1) {
            assert pos == 0;
            switch(onlytab) {
                case 0: return new certs__conf__all(0);
                case 1: return new certs__conf__all(1);
                default: return null;
            }
        }
    ...
    us.cash.scr.certs__conf__widgets w = null;
