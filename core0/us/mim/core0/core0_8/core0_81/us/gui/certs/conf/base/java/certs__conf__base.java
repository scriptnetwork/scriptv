...
//MIM    'controller': 'activity' @ core0/core0_8/core0_81/us/gui/certs/conf/mim.h
...
//MIM    'title': 'Certificates' @ core0/core0_8/core0_81/us/gui/certs/conf/mim.h
//MIM  kickoff code hash: 2rgs9jK4cHFhqU31KpTUm7EbZX1n (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash;
...
public abstract class certs__conf__base extends activity {

    private static void log(final String line) {           //--strip
        CFG.log_android("certs__conf__base: " + line);         //--strip
    }                                                      //--strip

    public certs__conf__base() {
        super();
        log("certs__conf__base constructor"); //--strip
    }
    ...
    @Override protected void controller__on_create(Bundle saved_state) {
        ...
        w = (us.cash.scr.certs__conf__base__widgets) super.w;
        assert w != null; //--strip
    ...
    @Override public us.cash.scr.view__widgets create_widgets() {
        return new us.cash.scr.certs__conf__base__widgets();
    }

    us.cash.scr.certs__conf__base__widgets w = null;
}
