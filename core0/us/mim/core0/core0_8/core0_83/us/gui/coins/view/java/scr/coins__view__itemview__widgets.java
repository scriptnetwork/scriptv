...
//MIM  kickoff code hash: 2sGVSsQruLHRzuaT2gBgdDDuWiGN (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash.scr;
...
public class coins__view__itemview__widgets extends list_view__itemview__widgets {

    private static void log(final String s) {                             //--strip
        CFG.log_scr("coins__view__itemview__widgets: " + s);            //--strip
    }                                                                     //--strip

    public coins__view__itemview__widgets() {
    }
    ...
    @Override public ViewGroup create_tree(Context ctx) { //aka inflate
        super.create_tree(ctx); {
            canvas_t left = new canvas_t(ctx, 12, 1); {
                ico = new button_t(ctx, R.raw.token, null); {
