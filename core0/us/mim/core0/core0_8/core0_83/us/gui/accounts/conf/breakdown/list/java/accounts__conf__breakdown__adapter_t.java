...
//MIM  kickoff code hash: 3xyb78HgSRLfKhzZb53nns7HmciT (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash;
...
public final class accounts__conf__breakdown__adapter_t extends list_view__adapter_t {

    private static void log(final String s) {                         //--strip
        CFG.log_scr("accounts__conf__breakdown__adapter_t: " + s);                //--strip
    }                                                                 //--strip

    public accounts__conf__breakdown__adapter_t(accounts__conf__breakdown main_view_) {
        super();
    ...
    public final account_t get_item(int pos) {
        assert data != null; //--strip
        return data.get(pos);
    }

    public void set_data(accounts_t data_) {
    ...
    public String get_nft(final account_t i) {
        return i.nft();
    }
    ...
    public account_t find_nft__item(final String nft) {
    ...
    accounts__conf__breakdown main_view;
    accounts_t data = null;
}
