...
//MIM    'include': ''
//MIM  kickoff code hash: 3jhRDXkQNZkbwzVHcKWPSa4GCmML (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash.scr;
...
public class accounts__conf__base__widgets extends view__widgets {

    private static void log(final String s) {                        //--strip
        us.cash.CFG.log_scr("accounts__conf__base__widgets: " + s);            //--strip
    }                                                                //--strip

    public accounts__conf__base__widgets() {
        super();
    }
