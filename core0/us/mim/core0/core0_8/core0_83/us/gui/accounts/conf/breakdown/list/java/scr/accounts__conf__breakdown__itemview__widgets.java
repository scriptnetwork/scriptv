...
//MIM  kickoff code hash: 3Qx9MooZaJaaKaWyW3Ee7wF9qhti (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash.scr;
...
public class accounts__conf__breakdown__itemview__widgets extends list_view__itemview__widgets {

    private static void log(final String s) {                             //--strip
        CFG.log_scr("accounts__conf__breakdown__itemview__widgets: " + s);            //--strip
    }                                                                     //--strip
    ...
    public accounts__conf__breakdown__itemview__widgets(listener_t listener_) {
        listener = listener_;
    }
    ...
    @Override public ViewGroup create_tree(Context ctx) {
        super.create_tree(ctx); {
            canvas_t left = new canvas_t(ctx, 12, 1); {
                ico = new button_t(ctx, R.raw.account, null); {
            ...
            canvas_t right = new canvas_t(ctx, 13, 1); {
                ...
                tail = new account_view_t(ctx, null); {
