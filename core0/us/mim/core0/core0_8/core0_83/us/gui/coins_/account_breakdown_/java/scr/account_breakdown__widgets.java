...
public class merged_accounts__widgets extends listview_fragment__widgets {

    private static void log(final String s) {                   //--strip
        CFG.log_scr("merged_accounts__widgets: " + s);            //--strip
    }                                                           //--strip

    public static class menu__modal_t extends menu_t {

        public menu__modal_t(Context ctx) {
            super(ctx, new menu_header_t(ctx, R.raw.coins_150, "Balances", "merged accounts", new View.OnClickListener() {
...
*/
    ...
    @Override public ViewGroup create_tree(Context ctx) { //aka inflate
        canvas_t canvas = new canvas_t(ctx, 10, 1); {
            ...
            */
            list = new merged_accounts__list_view_t(ctx); {
            }
