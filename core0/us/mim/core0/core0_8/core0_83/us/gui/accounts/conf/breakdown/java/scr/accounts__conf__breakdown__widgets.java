...
//MIM    'include': ''
//MIM  kickoff code hash: 2tbUmjng4hc4K2GtUVKxpaUcidTx (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash.scr;
...
public class accounts__conf__breakdown__widgets extends accounts__conf__breakdown0__widgets  {

    private static void log(final String s) {                        //--strip
        us.cash.CFG.log_scr("accounts__conf__breakdown__widgets: " + s);            //--strip
    }                                                                //--strip

    public accounts__conf__breakdown__widgets(final list_view_t.itemclick_listener_t list_listener_) {
        super();
