...
//MIM    'include': ''
//MIM  kickoff code hash: 3yYtSuYmFpR2xmv3x4dA5xekk1Fh (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash.scr;
...
public class accounts__conf__widgets extends accounts__conf__base__widgets {

    private static void log(final String s) {                        //--strip
        us.cash.CFG.log_scr("accounts__conf__widgets: " + s);            //--strip
    }                                                                //--strip

    public accounts__conf__widgets() {
        super();
    }
