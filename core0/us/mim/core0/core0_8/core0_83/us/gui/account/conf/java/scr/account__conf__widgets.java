...
//MIM    'include': ''
//MIM  kickoff code hash: 4E5DMKRR8AvQwf64ixy3XnrBv1va (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash.scr;
...
public class account__conf__widgets extends view__widgets {

    private static void log(final String s) {                        //--strip
        us.cash.CFG.log_scr("account__conf__widgets: " + s);            //--strip
    }                                                                //--strip

    public account__conf__widgets(final list_view_t.itemclick_listener_t coins_listener_) {
        super();
