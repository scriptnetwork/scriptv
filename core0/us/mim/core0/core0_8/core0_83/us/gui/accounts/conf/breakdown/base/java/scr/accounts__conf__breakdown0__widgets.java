...
//MIM    'include': ''
//MIM  kickoff code hash: 3zKkBqNb9rzCAEPAF8VX4geyNqkq (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash.scr;
...
public class accounts__conf__breakdown0__widgets extends view__widgets {

    private static void log(final String s) {                        //--strip
        us.cash.CFG.log_scr("accounts__conf__breakdown0__widgets: " + s);            //--strip
    }                                                                //--strip

    public accounts__conf__breakdown0__widgets() {
        super();
    }
