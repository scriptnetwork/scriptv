...
namespace us::gui::coins::account_breakdown {

    struct vertex_t: template_instance_vertex_t {
        using b = template_instance_vertex_t;

        vertex_t(): b("account_breakdown", "us::gui::activity::fragment::listview_fragment::template1",
            map<string, string>{
                {"MIM file", __FILE__},
                {"datatype", "accounts_t"},
                {"itemtype", "account_t"},
            ...
            codefiles.add_java();
            codefiles._mim_srcdir = "core0/core0_8/core0_83/us/gui/coins/account_breakdown";
