...
//MIM  kickoff code hash: 3VPi6uPFrasAkWcZqWdbzBF8iKt7 (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash.scr;
...
public class trades__conf__active0__widgets extends view__widgets {

    private static void log(final String s) {                        //--strip
        us.cash.CFG.log_scr("trades__conf__active0__widgets: " + s);            //--strip
    }                                                                //--strip

    public trades__conf__active0__widgets() {
        super();
    }
