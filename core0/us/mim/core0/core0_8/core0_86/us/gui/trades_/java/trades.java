...
public final class trades extends activity {
    ...
    private static void log(final String s) {       //--strip
        CFG.log_android("trades: " + s);            //--strip
    }                                               //--strip
    ...
    @Override public void toolbar_init(toolbar toolbar_) {
        toolbar_.set_stock_button__refresh(new View.OnClickListener() {
            @Override public void onClick(View view) {
                log("on_click_toolbar__refresh"); //--strip
                fetch();
            }
        });
    ...
    void fetch() {
        ...
        toast("calling API list_trades");
        log("calling API list_trades"); //--strip
        string s = new string();
        ko r = a.hmi().rpc_peer.call_list_trades(s); //slows the UI. must be doine in thread.
        on_trades(r, s.value);
    }
