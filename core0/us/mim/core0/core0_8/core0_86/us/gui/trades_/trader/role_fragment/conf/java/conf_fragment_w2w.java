...
public class conf_fragment_w2w extends conf_fragment {

    static void log(final String line) {                //--strip
       CFG.log_android("conf_fragment_w2w: " + line);     //--strip
    }                                                   //--strip

    static class coin_metadata_t {
        string name;
        string promise;
        blob_t img;
    }
    ...
    @Override public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        CoordinatorLayout w = (CoordinatorLayout) inflater.inflate(R.layout.conf_fragment_w2w, null);
        content.addView(w);
        bz.setTitle("BANK. Configuration");
        return v;
    }
