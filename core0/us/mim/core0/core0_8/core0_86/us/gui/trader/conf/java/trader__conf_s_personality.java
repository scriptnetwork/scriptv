...
//MIM  kickoff code hash: 3zNZkhMfh8gnernNe7MfgBoi2edJ (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash;
import us.string;
...
public abstract class trader__conf_s_personality extends trader__conf_s_status {

    private static void log(final String line) {                              //--strip
        CFG.log_android("trader__conf_s_personality: " + line);          //--strip
    }                                                                         //--strip

    public trader__conf_s_personality() {
        super();
    }
