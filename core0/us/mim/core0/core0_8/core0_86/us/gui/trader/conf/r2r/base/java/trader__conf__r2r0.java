...
//MIM    'controller': 'fragment' @ core0/core0_8/core0_86/us/gui/trader/conf/r2r/mim.h
...
//MIM    'title': 'Roles' @ core0/core0_8/core0_86/us/gui/trader/conf/r2r/mim.h
//MIM  kickoff code hash: 3cLcwz3BDeHgeExW3Q8qREqwWbjC (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash;
...
public abstract class trader__conf__r2r0 extends fragment {

    private static void log(final String line) {           //--strip
        CFG.log_android("trader__conf__r2r0: " + line);         //--strip
    }                                                      //--strip

    public trader__conf__r2r0() {
        super();
        log("trader__conf__r2r0 constructor"); //--strip
    }
    ...
    @Override protected void controller__on_create(Bundle saved_state) {
        ...
        w = (us.cash.scr.trader__conf__r2r0__widgets) super.w;
        assert w != null; //--strip
        tr = (trader__conf)ac;
    ...
    @Override public void load() {
        ...
        a.hmi().command_trade(tr.tid, "show roles");
    }
    ...
    @Override protected us.cash.scr.menu_t get_menu() {
        ...
        return us.cash.scr.trader__conf__r2r0__menu___main_t.get_instance(get_context());
    }
    //MIM end token 'get_menu_override'


    @Override public us.cash.scr.view__widgets create_widgets() {
        return new us.cash.scr.trader__conf__r2r0__widgets();
    }

    us.cash.scr.trader__conf__r2r0__widgets w = null;
    protected trader__conf__r2r__datatype_t roles = null; //MIM token 'datatype_decl'
    trader__conf tr;
}
