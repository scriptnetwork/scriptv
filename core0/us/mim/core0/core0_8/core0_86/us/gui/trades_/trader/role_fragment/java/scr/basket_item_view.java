...
public class basket_item_view extends LinearLayout {
    ...
    public void init(final activity ac_, hash_t prod_, pair<types.vol_t, basket_item_t> v, basket_view.on_click_listener click_handler_) {
        init_(ac_, prod_, v);
        mode = 0;
        ...
        itmbtn.setOnClickListener(new View.OnClickListener() {
            @Override public void onClick(View view) {
                ...
                ac_.a.new_dlg_builder().setTitle(btitle).setItems(options, new DialogInterface.OnClickListener() {
    ...
    public void init2(final activity ac_, hash_t prod_, pair<types.vol_t, basket_item_t> v, basket_view.on_click_listener2 click_handler2_) {
        init_(ac_, prod_, v);
        mode = 1;
        MaterialCardView itmbtn = findViewById(R.id.basket_item);
        itmbtn.setOnClickListener(new View.OnClickListener() {
