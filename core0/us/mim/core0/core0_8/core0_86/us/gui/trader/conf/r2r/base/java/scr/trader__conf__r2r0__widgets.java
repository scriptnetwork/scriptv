...
//MIM  Params:
//MIM    'classname': 'trader__conf__r2r0'
...
//MIM  kickoff code hash: U6iVV3F8ZXBUhRpnPJaQQorh3QY (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash.scr;
...
public class trader__conf__r2r0__widgets extends view__widgets {

    private static void log(final String s) {                        //--strip
        us.cash.CFG.log_scr("trader__conf__r2r0__widgets: " + s);            //--strip
    }                                                                //--strip

    public trader__conf__r2r0__widgets() {
        super();
    }
