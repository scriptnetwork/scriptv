...
//MIM    'classname': 'trader__conf__impl__base'
//MIM    'controller': 'activity' @ core0/core0_8/core0_86/us/gui/trader/conf/impl/mim.h
...
//MIM    'title': 'Trader' @ core0/core0_8/core0_86/us/gui/trader/conf/impl/mim.h
//MIM  kickoff code hash: 22MHbTAnLDdQQCKZdjc15HkX5LWY (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash;
...
public abstract class trader__conf__impl__base extends activity {

    private static void log(final String line) {           //--strip
        CFG.log_android("trader__conf__impl__base: " + line);         //--strip
    }                                                      //--strip

    public trader__conf__impl__base() {
        super();
        log("trader__conf__impl__base constructor"); //--strip
    }
    ...
    @Override protected void controller__on_create(Bundle saved_state) {
        ...
        w = (us.cash.scr.trader__conf__impl__base__widgets) super.w;
        assert w != null; //--strip
    ...
    @Override public us.cash.scr.view__widgets create_widgets() {
        return new us.cash.scr.trader__conf__impl__base__widgets();
    }

    us.cash.scr.trader__conf__impl__base__widgets w = null;
}
