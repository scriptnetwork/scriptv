...
public final class tradelog extends activity {
    ...
    @Override public void toolbar_init(toolbar toolbar_) {
        toolbar_.enable_refresh(new View.OnClickListener() {
            @Override public void onClick(View view) {
                log("on_refresh"); //--strip
                fetch();
            }
        });
    }
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ct.equals("data")) {
            content_type = ct;
            setTitle(getResources().getString(R.string.datatrade) + " " + tid.encode());
        }
        else if (ct.equals("log")) {
            log("setTitle Log trade #" + tid.encode()); //--strip
            setTitle("Log trade #" + tid.encode());
        }
    }
