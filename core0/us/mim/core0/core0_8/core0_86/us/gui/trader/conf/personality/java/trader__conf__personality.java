...
//MIM    'classname': 'trader__conf__personality'
//MIM    'controller': 'fragment' @ core0/core0_8/core0_86/us/gui/trader/conf/personality/mim.h
...
//MIM    'title': 'Personality' @ core0/core0_8/core0_86/us/gui/trader/conf/personality/mim.h
//MIM  kickoff code hash: 3JK1ad7sYHm21QgmKdFyAoQ5dUbL (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash;
...
public class trader__conf__personality extends fragment {

    private static void log(final String line) {           //--strip
        CFG.log_android("trader__conf__personality: " + line);         //--strip
    }                                                      //--strip

    public trader__conf__personality() {
        super();
        log("trader__conf__personality constructor"); //--strip
    }
    ...
    @Override protected void controller__on_create(Bundle saved_state) {
        ...
        w = (us.cash.scr.trader__conf__personality__widgets) super.w;
        assert w != null; //--strip
    ...
    @Override protected us.cash.scr.menu_t get_menu() {
        ...
        return us.cash.scr.trader__conf__personality__menu___main_t.get_instance(get_context());
    }
    //MIM end token 'get_menu_override'


    @Override public us.cash.scr.view__widgets create_widgets() {
        return new us.cash.scr.trader__conf__personality__widgets();
    }

    us.cash.scr.trader__conf__personality__widgets w = null;
}
