...
//MIM  kickoff code hash: pspf1atJzwUv855gqiWSbR146dF (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash;
...
public final class trader__conf__r2r__adapter_t extends list_view__adapter_t {

    private static void log(final String s) {                         //--strip
        CFG.log_scr("trader__conf__r2r__adapter_t: " + s);                //--strip
    }                                                                 //--strip

    public trader__conf__r2r__adapter_t(trader__conf__r2r main_view_) {
        super();
    ...
    public final trader__conf__r2r__itemtype_t get_item(int pos) {
        assert data != null; //--strip
        return data.get(pos);
    }

    public void set_data(trader__conf__r2r__datatype_t data_) {
    ...
    public String get_nft(final trader__conf__r2r__itemtype_t i) {
        return i.nft();
    }
    ...
    public int find_nft__pos(final String nft) {
        ...
        int p = -1;
        for (trader__conf__r2r__itemtype_t i: data) {
            ++p;
    ...
    public trader__conf__r2r__itemtype_t find_nft__item(final String nft) {
    ...
    trader__conf__r2r main_view;
    trader__conf__r2r__datatype_t data = null;
}
