...
//MIM  Params:
//MIM    'apifetch': 'public pair<ko, trad...' @ core0/core0_6/core0_61/us/gui/activity/controller/mim.h
//MIM    'class_qualifier': 'abstract ' @ core0/core0_6/core0_61/us/gui/activity/controller/mim.h
//MIM    'classname': 'trades__conf__active0'
//MIM    'controller': 'fragment' @ core0/core0_8/core0_86/us/gui/trades/conf/active/mim.h
//MIM    'datatype': 'trades__conf__active0__datatype_t' @ core0/core0_6/core0_61/us/gui/activity/listview_controller/base/mim.h
...
//MIM    'title': 'Trades' @ core0/core0_8/core0_86/us/gui/trades/conf/active/mim.h
//MIM  kickoff code hash: 79NsrDoKK1ujuN4rps1oYd9GCwa (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash;
...
public abstract class trades__conf__active0 extends fragment {

    private static void log(final String line) {           //--strip
        CFG.log_android("trades__conf__active0: " + line);         //--strip
    }                                                      //--strip

    public trades__conf__active0() {
        super();
        log("trades__conf__active0 constructor"); //--strip
    }
    ...
    @Override protected void controller__on_create(Bundle saved_state) {
        ...
        w = (us.cash.scr.trades__conf__active0__widgets) super.w;
        assert w != null; //--strip
    ...
    public pair<ko, trades__conf__active0__datatype_t> fetch_trades() {
        log("fetch_trades"); //--strip
        a.assert_worker_thread(); //--strip
        trades_index_t o = new trades_index_t();
        ko r = a.hmi().rpc_peer.call_trades_index(o);
        if (is_ko(r)) {
            return new pair<ko, trades__conf__active0__datatype_t>(r, null);
        }
        return new pair<ko, trades__conf__active0__datatype_t>(ok, new trades__conf__active0__datatype_t(o));
    }
    ...
    @Override public ko load__worker() {
        ...
        pair<ko, trades__conf__active0__datatype_t> r = fetch_trades();
        if (is_ko(r.first)) {
            trades = null;
            return r.first;
        }
        trades = r.second;
        assert trades != null; //--strip
        return ok;
    }
    ...
    @Override protected us.cash.scr.menu_t get_menu() {
        ...
        return us.cash.scr.trades__conf__active0__menu___main_t.get_instance(get_context());
    }
    //MIM end token 'get_menu_override'


    @Override public us.cash.scr.view__widgets create_widgets() {
        return new us.cash.scr.trades__conf__active0__widgets();
    }

    us.cash.scr.trades__conf__active0__widgets w = null;
    protected trades__conf__active0__datatype_t trades = null; //MIM token 'datatype_decl'
}
