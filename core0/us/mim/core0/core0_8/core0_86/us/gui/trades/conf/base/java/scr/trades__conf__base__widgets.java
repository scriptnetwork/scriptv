...
//MIM    'include': ''
//MIM  kickoff code hash: 32L5J4vBS55HFZEZ8F1hzbEBu5Uv (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash.scr;
...
public class trades__conf__base__widgets extends view__widgets {

    private static void log(final String s) {                        //--strip
        us.cash.CFG.log_scr("trades__conf__base__widgets: " + s);            //--strip
    }                                                                //--strip

    public trades__conf__base__widgets() {
        super();
    }
