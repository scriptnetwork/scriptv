...
public class fragment_co2vc_vc extends role_fragment  {

    static void log(final String line) {                       //--strip
        CFG.log_android("fragment_co2vc_vc: " + line);    //--strip
    }                                                          //--strip

    public fragment_co2vc_vc() {
    ...
    @Override public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle saved_state) {
        ...
        _cockpit_view = (cockpit_view) inflater.inflate(R.layout.cockpit_co2vc_vc, null);
