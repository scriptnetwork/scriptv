...
*/
   ...
   void button_proc(data_t data, Button b, final String thing) {
    ...
    void on_create_ai_request(final String type) {
        ...
        a.toast(getResources().getString(R.string.pleasewait));
    }
    ...
    void setup_handlers() {
        a.toolbar_.enable_create_aireq(new View.OnClickListener() {
            @Override public void onClick(View view) {
                String type;
                String[] options = parse_types();
                if (options != null) {
                    tr.a.new_dlg_builder().setTitle(getResources().getString(R.string.selectrequesttype))
    ...
    //toolbar_button create_ai_request;
}
