...
//MIM  kickoff code hash: yBoZTkD5TRaVM3KYnAMK9ZVQKhp (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash.scr;
...
public class trader__conf__r2r__widgets extends trader__conf__r2r0__widgets  {

    private static void log(final String s) {                        //--strip
        us.cash.CFG.log_scr("trader__conf__r2r__widgets: " + s);            //--strip
    }                                                                //--strip

    public trader__conf__r2r__widgets(final list_view_t.itemclick_listener_t list_listener_) {
        super();
