...
//MIM  kickoff code hash: 2bGb1jm6WrrQUBavfBaPTrrFtBTL (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash.scr;
...
public class trader__conf__chat0__widgets extends view__widgets {

    private static void log(final String s) {                        //--strip
        us.cash.CFG.log_scr("trader__conf__chat0__widgets: " + s);            //--strip
    }                                                                //--strip

    public trader__conf__chat0__widgets() {
        super();
    }
