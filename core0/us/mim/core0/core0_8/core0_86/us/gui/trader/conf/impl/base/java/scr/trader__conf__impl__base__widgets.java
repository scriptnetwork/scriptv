...
//MIM    'include': ''
//MIM  kickoff code hash: 2MhSpjwiMvZUuW1qHmTA1bj5Vzp1 (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash.scr;
...
public class trader__conf__impl__base__widgets extends view__widgets {

    private static void log(final String s) {                        //--strip
        us.cash.CFG.log_scr("trader__conf__impl__base__widgets: " + s);            //--strip
    }                                                                //--strip

    public trader__conf__impl__base__widgets() {
        super();
    }
