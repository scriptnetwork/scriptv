...
//MIM  kickoff code hash: 3RuWFAuo9k8Yt4UXuo3EkrxRCie8 (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash.scr;
...
public class trades__conf__active__widgets extends trades__conf__active0__widgets  {

    private static void log(final String s) {                        //--strip
        us.cash.CFG.log_scr("trades__conf__active__widgets: " + s);            //--strip
    }                                                                //--strip

    public trades__conf__active__widgets(final list_view_t.itemclick_listener_t list_listener_) {
        super();
