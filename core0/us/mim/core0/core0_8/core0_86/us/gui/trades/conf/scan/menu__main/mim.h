...
namespace us::gui::trades::conf::scan::menu__main {
        ...
        vertex_t(): b("menu__main", __FILE__) {
            struct menuspec_t: b::menuspec_t {
                menuspec_t(): b::menuspec_t("_main") {
                    header_icon = "R.raw.qr_scan_150";
                    header_title = "Scan QR";
                    header_subtitle = "Initiate a new trade from QR.";
                    header_title_resid = "-";
                    header_subtitle_resid = "-";

                    {
                        auto& g = find("usr");
                        g.add("R.raw.torch", "Toggle torch");
                    }
                }
            };
            codefiles.add_java();
