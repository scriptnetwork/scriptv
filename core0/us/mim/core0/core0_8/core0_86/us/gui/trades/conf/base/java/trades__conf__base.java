...
//MIM    'classname': 'trades__conf__base'
//MIM    'controller': 'activity' @ core0/core0_8/core0_86/us/gui/trades/conf/mim.h
...
//MIM    'title': 'Trades' @ core0/core0_8/core0_86/us/gui/trades/conf/mim.h
//MIM  kickoff code hash: 2RaBqxmGjHCC4sNGTZMUWjaYQRcE (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash;
...
public abstract class trades__conf__base extends activity {

    private static void log(final String line) {           //--strip
        CFG.log_android("trades__conf__base: " + line);         //--strip
    }                                                      //--strip

    public trades__conf__base() {
        super();
        log("trades__conf__base constructor"); //--strip
    }
    ...
    @Override protected void controller__on_create(Bundle saved_state) {
        ...
        w = (us.cash.scr.trades__conf__base__widgets) super.w;
        assert w != null; //--strip
    ...
    @Override public us.cash.scr.view__widgets create_widgets() {
        return new us.cash.scr.trades__conf__base__widgets();
    }

    us.cash.scr.trades__conf__base__widgets w = null;
}
