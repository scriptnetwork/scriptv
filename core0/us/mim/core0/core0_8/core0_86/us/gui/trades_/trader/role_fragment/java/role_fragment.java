...
public abstract class role_fragment extends fragment {
...
//        scroll =  v.findViewById(R.id.scroll);
        ...
        if (under_construction) {
            ...
            f_content.addView(_under_construction_view);
        }
    ...
    boolean logo = true;
    boolean under_construction = false;
