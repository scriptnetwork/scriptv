...
//MIM    'include': ''
//MIM  kickoff code hash: JLUqq5Xwzdje4b1cDDF8x82zNCb (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash.scr;
...
public class trader__conf__role__widgets extends view__widgets {

    private static void log(final String s) {                        //--strip
        us.cash.CFG.log_scr("trader__conf__role__widgets: " + s);            //--strip
    }                                                                //--strip

    public trader__conf__role__widgets() {
        super();
    }
    ...
    protected void create_papyrus(Context ctx) {
        papyrus = new canvas_t(ctx, 10, 1); {
            logo_view = new logo_view_t(ctx); {
            }
            tip_view = new tip_view_t(ctx); {
            }
            papyrus.addView(logo_view);
            papyrus.addView(tip_view);
        }
    }
    ...
    public logo_view_t logo_view;
    public tip_view_t tip_view;
}
