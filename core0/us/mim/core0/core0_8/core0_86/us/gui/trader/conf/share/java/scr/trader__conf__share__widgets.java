...
//MIM  Params:
//MIM    'classname': 'trader__conf__share'
//MIM    'create_tree': '@Override public Vie...' @ core0/core0_6/core0_61/us/gui/activity/controller/mim.h
//MIM    'include': ''
//MIM  kickoff code hash: 3y2JCP19tDtEp7ra6NoSiRTXoyn4 (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash.scr;
...
public class trader__conf__share__widgets extends view__widgets {

    private static void log(final String s) {                        //--strip
        us.cash.CFG.log_scr("trader__conf__share__widgets: " + s);            //--strip
    }                                                                //--strip

    public trader__conf__share__widgets() {
        super();
    }
