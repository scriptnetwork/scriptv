...
//MIM    'include': ''
//MIM  kickoff code hash: 2WYCfJC8LJHZ9dWTaLmpzqoxoQEG (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash.scr;
...
public class iot__conf__base__widgets extends view__widgets {

    private static void log(final String s) {                        //--strip
        us.cash.CFG.log_scr("iot__conf__base__widgets: " + s);            //--strip
    }                                                                //--strip

    public iot__conf__base__widgets() {
        super();
    }
