...
//MIM    'classname': 'iot__conf__base'
//MIM    'controller': 'activity' @ core0/core0_8/core0_84/us/gui/iot/conf/mim.h
...
//MIM    'title': 'Internet of Things' @ core0/core0_8/core0_84/us/gui/iot/conf/mim.h
//MIM  kickoff code hash: 3UmuJbNHswFBrfMB7fBUZD9RV3E (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash;
...
public abstract class iot__conf__base extends activity {

    private static void log(final String line) {           //--strip
        CFG.log_android("iot__conf__base: " + line);         //--strip
    }                                                      //--strip

    public iot__conf__base() {
        super();
        log("iot__conf__base constructor"); //--strip
    }
    ...
    @Override protected void controller__on_create(Bundle saved_state) {
        ...
        w = (us.cash.scr.iot__conf__base__widgets) super.w;
        assert w != null; //--strip
    ...
    @Override public us.cash.scr.view__widgets create_widgets() {
        return new us.cash.scr.iot__conf__base__widgets();
    }

    us.cash.scr.iot__conf__base__widgets w = null;
}
