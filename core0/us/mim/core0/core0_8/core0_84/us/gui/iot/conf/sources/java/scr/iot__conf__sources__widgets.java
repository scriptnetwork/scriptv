...
//MIM  kickoff code hash: 3pHkRdYHSMrBjR6ZDEXkaSSjJKyX (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash.scr;
...
public class iot__conf__sources__widgets extends iot__conf__sources0__widgets  {

    private static void log(final String s) {                        //--strip
        us.cash.CFG.log_scr("iot__conf__sources__widgets: " + s);            //--strip
    }                                                                //--strip

    public iot__conf__sources__widgets(final list_view_t.itemclick_listener_t list_listener_) {
        super();
