...
//MIM  kickoff code hash: 2HQVYY1Y4LsVLzLXGwZNwKgmpHS8 (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash.scr;
...
public class iot__conf__sources0__widgets extends view__widgets {

    private static void log(final String s) {                        //--strip
        us.cash.CFG.log_scr("iot__conf__sources0__widgets: " + s);            //--strip
    }                                                                //--strip

    public iot__conf__sources0__widgets() {
        super();
    }
