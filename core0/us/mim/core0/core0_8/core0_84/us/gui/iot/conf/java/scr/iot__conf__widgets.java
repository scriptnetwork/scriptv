...
//MIM    'include': ''
//MIM  kickoff code hash: Nr1e31gZEysQHzryBKEFe7wFqQj (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash.scr;
...
public class iot__conf__widgets extends iot__conf__base__widgets {

    private static void log(final String s) {                        //--strip
        us.cash.CFG.log_scr("iot__conf__widgets: " + s);            //--strip
    }                                                                //--strip

    public iot__conf__widgets() {
        super();
    }
