...
//MIM  kickoff code hash: 3XMHwrBvwuLqhkt5vxusC3mreqC9 (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash.scr;
...
public class iot__conf__sources__itemview__widgets extends list_view__itemview__widgets {

    private static void log(final String s) {                             //--strip
        CFG.log_scr("iot__conf__sources__itemview__widgets: " + s);            //--strip
    }                                                                     //--strip
    ...
    public iot__conf__sources__itemview__widgets(listener_t listener_) {
        listener = listener_;
    }
    ...
    @Override public ViewGroup create_tree(Context ctx) {
        super.create_tree(ctx); {
            canvas_t left = new canvas_t(ctx, 12, 1); {
                ico = new button_t(ctx, R.raw.streams, null); {
