...
//MIM  kickoff code hash: 2V1N4p7BdZ6XPy2HWZYp6cEgXHYs (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash;
...
public final class iot__conf__sources__adapter_t extends list_view__adapter_t {

    private static void log(final String s) {                         //--strip
        CFG.log_scr("iot__conf__sources__adapter_t: " + s);                //--strip
    }                                                                 //--strip

    public iot__conf__sources__adapter_t(iot__conf__sources main_view_) {
        super();
    ...
    public final iot__conf__sources0__itemtype_t get_item(int pos) {
        assert data != null; //--strip
        return data.get(pos);
    }

    public void set_data(iot__conf__sources0__datatype_t data_) {
    ...
    public String get_nft(final iot__conf__sources0__itemtype_t i) {
        return i.nft();
    }
    ...
    public int find_nft__pos(final String nft) {
        ...
        int p = -1;
        for (iot__conf__sources0__itemtype_t i: data) {
            ++p;
    ...
    public iot__conf__sources0__itemtype_t find_nft__item(final String nft) {
    ...
    iot__conf__sources main_view;
    iot__conf__sources0__datatype_t data = null;
}
