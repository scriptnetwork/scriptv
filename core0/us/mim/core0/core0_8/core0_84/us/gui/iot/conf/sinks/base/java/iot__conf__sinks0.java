...
//MIM    'controller': 'fragment' @ core0/core0_8/core0_84/us/gui/iot/conf/sinks/mim.h
//MIM    'datatype': 'iot__conf__sinks0__datatype_t' @ core0/core0_8/core0_84/us/gui/iot/conf/sinks/base/mim.h
...
//MIM    'title': 'Sink Addresses' @ core0/core0_8/core0_84/us/gui/iot/conf/sinks/mim.h
//MIM  kickoff code hash: 3eMM6GyXR9YqygL8cjKW1pVik9mb (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash;
...
public abstract class iot__conf__sinks0 extends fragment {

    private static void log(final String line) {           //--strip
        CFG.log_android("iot__conf__sinks0: " + line);         //--strip
    }                                                      //--strip

    public iot__conf__sinks0() {
        super();
        log("iot__conf__sinks0 constructor"); //--strip
    }
    ...
    @Override protected void controller__on_create(Bundle saved_state) {
        ...
        w = (us.cash.scr.iot__conf__sinks0__widgets) super.w;
        assert w != null; //--strip
    ...
    @Override public String get_title() {
        return "Sink Addresses";
    }

    //MIM begin token 'apifetch'
    public pair<ko, iot__conf__sinks0__datatype_t> fetch_sinks() {
        log("fetch_sinks"); //--strip
        a.assert_worker_thread(); //--strip
        timeseries_index_t o = new timeseries_index_t();
        ko r = a.hmi().rpc_peer.call_timeseries_list1(o);
        if (is_ko(r)) {
            return new pair<ko, iot__conf__sinks0__datatype_t>(r, null);
        }
        return new pair<ko, iot__conf__sinks0__datatype_t>(ok, new iot__conf__sinks0__datatype_t(o));
    }
    ...
    @Override public ko load__worker() {
        ...
        pair<ko, iot__conf__sinks0__datatype_t> r = fetch_sinks();
        if (is_ko(r.first)) {
            sinks = null;
            return r.first;
        }
        sinks = r.second;
        assert sinks != null; //--strip
        return ok;
    }
    ...
    @Override protected us.cash.scr.menu_t get_menu() {
        ...
        return us.cash.scr.iot__conf__sinks0__menu___main_t.get_instance(get_context());
    }
    //MIM end token 'get_menu_override'

    //MIM begin token 'on_menu__handling'
    protected abstract void on_menu__main__bnew(); //New sink address

    @Override public boolean on_menu(int id) {
        log("on_menu"); //--strip
        if (id == R.raw.bnew) { //New sink address
    ...
    @Override public us.cash.scr.view__widgets create_widgets() {
        return new us.cash.scr.iot__conf__sinks0__widgets();
    }

    us.cash.scr.iot__conf__sinks0__widgets w = null;
    protected iot__conf__sinks0__datatype_t sinks = null; //MIM token 'datatype_decl'
}
