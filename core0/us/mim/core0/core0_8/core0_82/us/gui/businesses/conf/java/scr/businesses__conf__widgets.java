...
//MIM  kickoff code hash: 2Jam7Ave7o8kA1vvL8XzQnyQ9RLE (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash.scr;
...
public class businesses__conf__widgets extends businesses__conf0__widgets  {

    private static void log(final String s) {                        //--strip
        us.cash.CFG.log_scr("businesses__conf__widgets: " + s);            //--strip
    }                                                                //--strip

    public businesses__conf__widgets(final list_view_t.itemclick_listener_t list_listener_) {
        super();
