...
//MIM  kickoff code hash: 3Y7DipDaQcp23T7tL5TpPpyJsoME (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash.scr;
...
public class businesses__conf0__widgets extends view__widgets {

    private static void log(final String s) {                        //--strip
        us.cash.CFG.log_scr("businesses__conf0__widgets: " + s);            //--strip
    }                                                                //--strip

    public businesses__conf0__widgets() {
        super();
    }
