...
//MIM    'data_identifier': 'bzs' @ core0/core0_8/core0_82/us/gui/businesses/mim.h
...
//MIM    'item_object_id': 'app.protocol_selection__object_id' @ core0/core0_8/core0_82/us/gui/businesses/mim.h
//MIM    'item_title': 'business' @ core0/core0_8/core0_82/us/gui/businesses/mim.h
...
//MIM  kickoff code hash: 28zc9kqUAg4Ed7tKRJt5Do8VFBQk (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash;
...
public class businesses__conf extends businesses__conf0 {

    private static void log(final String line) {           //--strip
        CFG.log_android("businesses__conf: " + line);         //--strip
    }                                                      //--strip

    public businesses__conf() {
        super();
        log("businesses__conf constructor"); //--strip
    }
    ...
    @Override protected void controller__on_create(Bundle saved_state) {  //create/resume order: 1-general class; 2-specialized class
        ...
        w = (us.cash.scr.businesses__conf__widgets) super.w;
        assert w != null; //--strip
    }
    ...
    public void bind(final protocols_t o) {
        log("bind"); //--strip
    }

    @Override public us.cash.scr.view__widgets create_widgets() {
        final businesses__conf self = this;
        return new us.cash.scr.businesses__conf__widgets(new us.cash.scr.list_view_t.itemclick_listener_t() {
    ...
    us.cash.scr.businesses__conf__itemview__widgets create_itemview__widgets() {
        final businesses__conf self = this;
        return new us.cash.scr.businesses__conf__itemview__widgets(new us.cash.scr.businesses__conf__itemview__widgets.listener_t() {
    ...
    public us.cash.scr.list_view__itemview_t create_itemview(Context ctx) {
         return new us.cash.scr.businesses__conf__itemview_t(ctx, create_itemview__widgets(), adapter);
    }

    public businesses__conf__adapter_t create_adapter() {
        log("create_adapter");
        adapter = new businesses__conf__adapter_t(this);
    ...
    void on_item__long_click(final int pos) {
        ...
        //TODO: do something
        //protocol_selection_t item = adapter.get_item(pos);
    }
    ...
    public void popup_menu__conf(final int pos) {
        ...
        a.show_contextual_options_for(get_context(), R.raw.business, "business " + item.to_string(), app.protocol_selection__object_id, item);
    }
    //MIM end token 'popups'

    protected us.cash.scr.businesses__conf__widgets w = null;
    public businesses__conf__adapter_t adapter = null;
