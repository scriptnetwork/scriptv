...
//MIM    'include': ''
//MIM  kickoff code hash: 4FaQmuQ94gqBwsoHnxkNZC9tz1pU (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash.scr;
...
public class device_endpoints__conf0__widgets extends view__widgets {

    private static void log(final String s) {                        //--strip
        us.cash.CFG.log_scr("device_endpoints__conf0__widgets: " + s);            //--strip
    }                                                                //--strip

    public device_endpoints__conf0__widgets() {
        super();
    }
