...
//MIM
//MIM  Source:
//MIM        file: core0/core0_9/us/gui/r2r/symmetric/java/scr/trader__[protocol]_[role]__widgets.java
...
//MIM  kickoff code hash: 3C3hZGSo1XJZCDDPd8N7bM35v5eB (change this hash to force a review)
//MIM  ******************************************************************************
package us.cash.scr;
...
public class trader__w2w_w__widgets extends trader__conf__role__widgets {

    private static void log(final String s) {                        //--strip
        us.cash.CFG.log_scr("trader__w2w_w__widgets: " + s);            //--strip
    }                                                                //--strip

    public trader__w2w_w__widgets(View.OnClickListener search_listener_) {
        super();
