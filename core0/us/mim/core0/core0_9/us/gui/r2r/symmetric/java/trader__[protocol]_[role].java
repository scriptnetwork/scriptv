...
public class trader__##protocol##_##role## extends trader__conf__role  {

    static void log(final String line) {             //--strip
        CFG.log_android("trader__##protocol##_##role##: " + line);    //--strip
    }                                                //--strip

    public trader__##protocol##_##role##() {
        super(new protocol_selection_t("##protocol##", "##role##"));
    }
    ...
    @Override protected void controller__on_create(Bundle saved_state) {
        ...
        w = (us.cash.scr.trader__##protocol##_##role##__widgets) super.w;
        assert w != null; //--strip
    }
    ...
    @Override public us.cash.scr.view__widgets create_widgets() {
        return new us.cash.scr.trader__##protocol##_##role##__widgets(new View.OnClickListener() {
