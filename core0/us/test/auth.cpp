...
void test_auth_app() {
    ...
    o.self_test();
    cout << "us::gov::engine::daemon_t destructor" << endl;
}
...
void test_auth_apps() {
    cout << "test_auth_apps" << endl;
    auth_apps o(cout);
    o.self_test();
    cout << "end test_auth_apps" << endl;
}
...
void test_auth() {
        ...
        assert(false);
    #endif
    tee("auth", "max_nodes_per_ip", (int)::us::gov::engine::auth::collusion_control_t::max_nodes_per_ip);
