...
namespace us::gov::cash {
    ...
    struct safe_deposit_box final: io::seriable {
        ...
        static constexpr cash_t burn_fee{CFG_CRYPTOECONOMICS_BURN_FEE};
        ...
        ko merge(const safe_deposit_box&);
        ...
        bool burn(const hash_t& addr, const hash_t& token, const cash_t& amount, cash_t& fee);
