...
#include <us/wallet/engine/data_sources_index_t.h>
#include <us/wallet/wallet/timeseries_index_t.h>
...
namespace us::wallet::wallet {
    ...
    struct local_api final: algorithm, handler_api {
        ...
        using data_sources_index_t = us::wallet::engine::data_sources_index_t;
        using timeseries_index_t = us::wallet::wallet::timeseries_index_t;
        ...
        using account_t = w::account_t;
        using accounts_t = w::accounts_t;
    ...
    public:
        ...
        string timeseries_payload(const hash_t& addr) const;
        string timeseries_payload(const hash_t& addr, ts_t ts_from, ts_t ts_to) const;
