...
#define loglevel "trader/r2r/co2vc/co"
#define logclass "protocol"
#include <us/gov/logs.inc>

using namespace us::trader::r2r::co2vc::co;
using c = us::trader::r2r::co2vc::co::protocol;
using us::ko;

const char* c::rolestr() const { return "co"; }
const char* c::peer_rolestr() const { return "vc"; }
const char* c::get_name() const { return name; };

c::protocol(business_t& bz): b(bz) {
    log("created protocol_co2vc_co");
}

c::~protocol() {
    log("destroyed protocol_co2vc_co");
}
...
c::factory_id_t c::factory_id() const {
    return protocol_selection_t("co2vc", "co");
}
