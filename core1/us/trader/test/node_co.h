...
namespace us::test {
    ...
    struct node_co: node {
        ...
        node_co(const string& id, const string& homedir, const string& logdir, const string& vardir, uint16_t gport, uint16_t wport);
        ...
        void create_co(const string& r2rhome); //, vector<node*> processors, bookmarks_t&&);
