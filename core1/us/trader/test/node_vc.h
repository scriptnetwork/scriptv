...
namespace us::test {
    ...
    struct node_vc: node {
        ...
        node_vc(const string& id, const string& homedir, const string& logdir, const string& vardir, uint16_t gport, uint16_t wport);
        ...
        void create_vc(const string& r2rhome); //, vector<node*> processors, bookmarks_t&&);
