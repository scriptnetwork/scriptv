...
namespace us::trader::workflow::organization {
    ...
    public:
        static constexpr item_factory_id_t cert_factory_id{1};
        static constexpr item_factory_id_t appointment_factory_id{2};
        static constexpr item_factory_id_t reference_factory_id{3};
        static constexpr item_factory_id_t precontract_factory_id{4};
        static constexpr item_factory_id_t contract_factory_id{5};
        void register_factories(item_factories_t&) const override;

    public:
        bitem* enable_cert(bool, ch_t&);
        bitem* enable_appointment(bool, ch_t&);
        bitem* enable_reference(bool, ch_t&);
        bitem* enable_precontract(bool, ch_t&);
        bitem* enable_contract(bool, ch_t&);
    };
